...
public class MainActivity extends  AppCompatActivity  { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		no_conn = (LinearLayout) findViewById(R.id.no_conn);
		...
		_app_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (_childKey.equals("Earnburn Inc")) {
					if (_childValue.get("app").toString().equals("true")) {
						...
						SketchwareUtil.showMessage(getApplicationContext(), "App is no longer Available");
					}
				}
			}
